...
function Account() {
  ...
  return (
    <Accordion type="multiple" className="w-full justify-start p-8" value={['account_details', 'account_services']}>
      <AccordionItem value="account_details" className="border-1 mb-3">
        ...
        <AccordionContent className="flex flex-col gap-4 text-balance bg-sidebar px-7 py-3">
          ...
          <Button variant="outline" className="flex ml-auto w-full cursor-pointer">
            <WrenchIcon />
            Change User Details
          </Button>
        </AccordionContent>
