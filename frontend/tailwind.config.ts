  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'button-active': '0px 2px 6px -2px #00000059 inset, 0px 0px 2px 0px #00000059 inset',
        input: '0px 2px 5px -2px #00000040, 0px 0px 2px 0px #00000040, inset 0 0 0px 1000px #FFFFFF', // to remove autofill bg color
